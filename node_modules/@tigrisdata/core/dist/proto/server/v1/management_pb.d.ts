...
export class NamespaceInfoRequest extends jspb.Message { 
    getId(): string;
    setId(value: string): NamespaceInfoRequest;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): NamespaceInfoRequest.AsObject;
    static toObject(includeInstance: boolean, msg: NamespaceInfoRequest): NamespaceInfoRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: NamespaceInfoRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): NamespaceInfoRequest;
    static deserializeBinaryFromReader(message: NamespaceInfoRequest, reader: jspb.BinaryReader): NamespaceInfoRequest;
}

export namespace NamespaceInfoRequest {
    export type AsObject = {
        id: string,
    }
}

export class NamespaceInfoResponse extends jspb.Message { 

    hasNamespaceInfo(): boolean;
    clearNamespaceInfo(): void;
    getNamespaceInfo(): NamespaceInfo | undefined;
    setNamespaceInfo(value?: NamespaceInfo): NamespaceInfoResponse;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): NamespaceInfoResponse.AsObject;
    static toObject(includeInstance: boolean, msg: NamespaceInfoResponse): NamespaceInfoResponse.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: NamespaceInfoResponse, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): NamespaceInfoResponse;
    static deserializeBinaryFromReader(message: NamespaceInfoResponse, reader: jspb.BinaryReader): NamespaceInfoResponse;
}

export namespace NamespaceInfoResponse {
    export type AsObject = {
        namespaceInfo?: NamespaceInfo.AsObject,
    }
}
