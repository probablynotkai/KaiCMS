...
goog.exportSymbol('proto.tigrisdata.management.v1.NamespaceInfoRequest', null, global);
goog.exportSymbol('proto.tigrisdata.management.v1.NamespaceInfoResponse', null, global);
 ...
 * @constructor
 */
proto.tigrisdata.management.v1.NamespaceInfoRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.tigrisdata.management.v1.NamespaceInfoRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.tigrisdata.management.v1.NamespaceInfoRequest.displayName = 'proto.tigrisdata.management.v1.NamespaceInfoRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.tigrisdata.management.v1.NamespaceInfoResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.tigrisdata.management.v1.NamespaceInfoResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.tigrisdata.management.v1.NamespaceInfoResponse.displayName = 'proto.tigrisdata.management.v1.NamespaceInfoResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.tigrisdata.management.v1.NamespaceInfoRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.tigrisdata.management.v1.NamespaceInfoRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.tigrisdata.management.v1.NamespaceInfoRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tigrisdata.management.v1.NamespaceInfoRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.tigrisdata.management.v1.NamespaceInfoRequest}
 */
proto.tigrisdata.management.v1.NamespaceInfoRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.tigrisdata.management.v1.NamespaceInfoRequest;
  return proto.tigrisdata.management.v1.NamespaceInfoRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.tigrisdata.management.v1.NamespaceInfoRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.tigrisdata.management.v1.NamespaceInfoRequest}
 */
proto.tigrisdata.management.v1.NamespaceInfoRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.tigrisdata.management.v1.NamespaceInfoRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.tigrisdata.management.v1.NamespaceInfoRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.tigrisdata.management.v1.NamespaceInfoRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tigrisdata.management.v1.NamespaceInfoRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.tigrisdata.management.v1.NamespaceInfoRequest.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.tigrisdata.management.v1.NamespaceInfoRequest} returns this
 */
proto.tigrisdata.management.v1.NamespaceInfoRequest.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.tigrisdata.management.v1.NamespaceInfoResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.tigrisdata.management.v1.NamespaceInfoResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.tigrisdata.management.v1.NamespaceInfoResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tigrisdata.management.v1.NamespaceInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    namespaceInfo: (f = msg.getNamespaceInfo()) && proto.tigrisdata.management.v1.NamespaceInfo.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.tigrisdata.management.v1.NamespaceInfoResponse}
 */
proto.tigrisdata.management.v1.NamespaceInfoResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.tigrisdata.management.v1.NamespaceInfoResponse;
  return proto.tigrisdata.management.v1.NamespaceInfoResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.tigrisdata.management.v1.NamespaceInfoResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.tigrisdata.management.v1.NamespaceInfoResponse}
 */
proto.tigrisdata.management.v1.NamespaceInfoResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.tigrisdata.management.v1.NamespaceInfoResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.tigrisdata.management.v1.NamespaceInfoResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.tigrisdata.management.v1.NamespaceInfoResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tigrisdata.management.v1.NamespaceInfoResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * optional NamespaceInfo namespace_info = 1;
 * @return {?proto.tigrisdata.management.v1.NamespaceInfo}
 */
proto.tigrisdata.management.v1.NamespaceInfoResponse.prototype.getNamespaceInfo = function() {
  return /** @type{?proto.tigrisdata.management.v1.NamespaceInfo} */ (
    jspb.Message.getWrapperField(this, proto.tigrisdata.management.v1.NamespaceInfo, 1));
};


/**
 * @param {?proto.tigrisdata.management.v1.NamespaceInfo|undefined} value
 * @return {!proto.tigrisdata.management.v1.NamespaceInfoResponse} returns this
*/
proto.tigrisdata.management.v1.NamespaceInfoResponse.prototype.setNamespaceInfo = function(value) {
 ...
 * @return {!proto.tigrisdata.management.v1.NamespaceInfoResponse} returns this
 */
proto.tigrisdata.management.v1.NamespaceInfoResponse.prototype.clearNamespaceInfo = function() {
  return this.setNamespaceInfo(undefined);
};
 ...
 * @return {boolean}
 */
proto.tigrisdata.management.v1.NamespaceInfoResponse.prototype.hasNamespaceInfo = function() {
  return jspb.Message.getField(this, 1) != null;
};
