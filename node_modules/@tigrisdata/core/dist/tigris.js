...
class Tigris {
    ...
    constructor(config) {
        ...
        if ((config.serverUrl.includes("localhost") ||
            ...
            this.grpcClient = new api_grpc_pb_1.TigrisClient(config.serverUrl, insecureCreds);
            ...
            this.searchClient = new search_grpc_pb_1.SearchClient(config.serverUrl, insecureCreds);
            ...
            this.grpcClient = new api_grpc_pb_1.TigrisClient(config.serverUrl, channelCreds);
            ...
            this.searchClient = new search_grpc_pb_1.SearchClient(config.serverUrl, channelCreds);
    ...
    createCacheIfNotExists(name) {
        return new Promise((resolve, reject) => {
            ...
            (error, response) => {
                if (error && error.code != constants_1.Status.ALREADY_EXISTS) {
                    reject(error);
                }
                else {
